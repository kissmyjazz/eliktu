...
# Adds both numeric and factor age variables to have flexibility in downstream modelling
data$age_cent_f <- data$age_cent
...
kohort_1_df$age_cent_f <- factor(kohort_1_df$age_cent_f, levels = c(-3, 0, 7),
...
kohort_2_df$age_cent_f <- factor(kohort_2_df$age_cent_f, levels = c(0, 7, 15),
                               labels = c("18 years", "25 years", "33 years"))

################################################################################
# Calcium & Mimp
# model 1 for cohort 1
model_c1_calcium_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Calcium_9 + Calcium +
                     (1 | kood),
...
# model for cohort 2
model_c2_calcium_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Calcium +
                     (1 | kood),
...
# Calcium & Aimp
# model 1 for cohort 1
model_c1_calcium_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Calcium_9 + Calcium +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_calcium_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Calcium +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Iodine & Mimp
# model 1 for cohort 1
model_c1_Iodine_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Iodine_9 + Iodine +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Iodine_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Iodine +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Iodine & Aimp
# model 1 for cohort 1
model_c1_Iodine_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Iodine_9 + Iodine +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Iodine_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Iodine +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Iron & Mimp
# model 1 for cohort 1
model_c1_Iron_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Iron_9 + Iron +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Iron_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Iron +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Iron & Aimp
# model 1 for cohort 1
model_c1_Iron_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Iron_9 + Iron +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Iron_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Iron +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Magnesium & Mimp
# model 1 for cohort 1
model_c1_Magnesium_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Magnesium_9 + Magnesium +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Magnesium_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Magnesium +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Magnesium & Aimp
# model 1 for cohort 1
model_c1_Magnesium_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Magnesium_9 + Magnesium +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Magnesium_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Magnesium +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Manganese & Mimp
# model 1 for cohort 1
model_c1_Manganese_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Mangane_9 + Manganese +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Manganese_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Manganese +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Manganese & Aimp
# model 1 for cohort 1
model_c1_Manganese_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Mangane_9 + Manganese +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Manganese_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Manganese +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Phosphorus & Mimp
# model 1 for cohort 1
model_c1_Phosphorus_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Phosphor_9 + Phosphorus +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Phosphorus_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Phosphorus +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Phosphorus & Aimp
# model 1 for cohort 1
model_c1_Phosphorus_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Phosphor_9 + Phosphorus +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Phosphorus_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Phosphorus +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Potassium & Mimp
# model 1 for cohort 1
model_c1_Potassium_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Potassium_9 + Potassium +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Potassium_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Potassium +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Potassium & Aimp
# model 1 for cohort 1
model_c1_Potassium_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Potassium_9 + Potassium +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Potassium_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Potassium +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Selenium & Mimp
# model 1 for cohort 1
model_c1_Selenium_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Selenium_9 + Selenium +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Selenium_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Selenium +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Selenium & Aimp
# model 1 for cohort 1
model_c1_Selenium_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Selenium_9 + Selenium +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Selenium_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Selenium +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Sodium & Mimp
# model 1 for cohort 1
model_c1_Sodium_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Sodium_9 + Sodium +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Sodium_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Sodium +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Sodium & Aimp
# model 1 for cohort 1
model_c1_Sodium_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Sodium_9 + Sodium +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Sodium_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Sodium +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Zink & Mimp
# model 1 for cohort 1
model_c1_Zink_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Zink +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Zink_mimp <- lmer(Mimp ~ Aimp + age_cent_f + Wmaxkg + sugu + Zink +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Zink & Aimp
# model 1 for cohort 1
model_c1_Zink_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Zink_9 + Zink +
                                (1 | kood),
                              REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Zink_aimp <- lmer(Aimp ~ Mimp + age_cent_f + Wmaxkg + sugu + Zink +
                                (1 | kood),
                              REML = TRUE, data = kohort_2_df)
...
# Zink & Aimp ver 2
# model 1 for cohort 1
model_c1_Zink_aimp_2 <- lmer(Aimp ~ Mimp + age_cent_f + sugu + Zink +
                             (1 | kood),
                           REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Zink_aimp_2 <- lmer(Aimp ~ Mimp + age_cent_f + sugu + Zink +
                             (1 | kood),
                           REML = TRUE, data = kohort_2_df)
...
# Zink & Fast ver 2
# model 1 for cohort 1
model_c1_Zink_Fast_2 <- lmer(Fast ~ Mimp + age_cent_f + sugu + Zink +
                               (1 | kood),
                             REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Zink_Fast_2 <- lmer(Fast ~ Mimp + age_cent_f + sugu + Zink +
                               (1 | kood),
                             REML = TRUE, data = kohort_2_df)
...
# Zink & Excite ver 2
# model 1 for cohort 1
model_c1_Zink_Excite_2 <- lmer(Excite ~ Mimp + age_cent_f + sugu + Zink +
                               (1 | kood),
                             REML = TRUE, data = kohort_1_df)
...
# model for cohort 2
model_c2_Zink_Excite_2 <- lmer(Excite ~ Mimp + age_cent_f + sugu + Zink +
                               (1 | kood),
                             REML = TRUE, data = kohort_2_df)
